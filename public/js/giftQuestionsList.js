        ...
        success: (res) => {
            ...
            for (let i = 0; i < allGiftQuestions.length; i++) {
                ...
                if (adminPosition != "guest") {
                    ...
                    tempRow.push(allGiftQuestions[i].giftQuestionType);
                    tempRow.push(allGiftQuestions[i].giftQuestion);
                    tempRow.push(`<input type="button" id="${allGiftQuestions[i].giftQuestion_id}" onclick="alert('권한이 필요한 작업입니다!')"
                                    class="btn btn-outline-primary" value="상세페이지">`);
                    tempRow.push(
                        `<img src="../public/assets/img/deleteBtn.png" id="delete${allGiftQuestions[i].giftQuestion_id}" onClick="alert('권한이 필요한 작업입니다!')" width="40px" style="cursor:pointer;">`
                    );
                }
